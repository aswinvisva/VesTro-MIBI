...
def feed_features_iterator(mibi_features: pd.DataFrame,
    ...
    for feed_idx in range(all_feeds_data.shape[0]):
        ...
        brain_region_point_ranges = all_feeds_metadata.loc[idx[feed_idx, 0], "Feed"].brain_region_point_ranges
        brain_region_names = all_feeds_metadata.loc[idx[feed_idx, 0], "Feed"].brain_region_names
        ...
        if save_to_dir:
            ...
            yield feed_idx, feed_contours, feed_features, feed_dir, brain_region_point_ranges, brain_region_names
        else:
            yield feed_idx, feed_contours, feed_features, brain_region_point_ranges, brain_region_names
